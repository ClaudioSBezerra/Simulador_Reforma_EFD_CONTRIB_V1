...
const FretePanel: React.FC<FretePanelProps> = ({ spedData, taxRates, year, branches }) => {
  const [indOperFilter, setIndOperFilter] = useState<number>(0); // Default Entradas
  ...
  const filtered = spedData.d100.filter(rec => {
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan={8} className="px-8 py-12 text-center text-gray-400 italic">Nenhum registro de transporte encontrado para os filtros selecionados.</td>
                </tr>
              )}
            </tbody>
          </table>
